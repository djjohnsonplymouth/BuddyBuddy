...
extern void *mono_aot_module_Buddy_BuddyBuddy_BuddyWatchExtension_info;
extern void *mono_aot_module_mscorlib_info;
extern void *mono_aot_module_Xamarin_WatchOS_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_Buddy_BuddyBuddy_BuddyWatchExtension_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "Buddy-BuddyBuddy-BuddyWatchExtension.dll";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
...
int xamarin_watchextension_main (int argc, char **argv)
{
	...
	argv [0] = (char *) "Buddy-BuddyBuddy-BuddyWatchExtension";
